...
<div class="header-bot">
    <div class="header-bot_inner_wthreeinfo_header_mid">
        ...
        <div class="col-md-4 logo_agile">
            <h1><a href="index.html"><span>T</span>oko Grosir </a></h1>
        </div>
        {{--<!-- header-bot -->--}}
        {{--@if (Route::has('login'))--}}
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active" style="background:-webkit-linear-gradient(rgba(23, 22, 23, 0.2), rgba(23, 22, 23, 0.5)), url({{ asset('public/uploads/2017-08/banner1.jpg') }}) no-repeat;background-size:cover;">
            {{--<img src="{{ asset('public/uploads/2017-08/banner1.jpg') }}">--}}
            <div class="container">
...
<div class="new_arrivals_agile_w3ls_info">
    <div class="container">
        <h3 class="wthree_text_info">KATALOG <span>PRODUK</span></h3>
                        ...
                        <div class="men-pro-item simpleCart_shelfItem">
                            <div class="men-thumb-item">
                                ...
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="{{ url ('/detail/'.App\Http\Controllers\Functions::encode($data->id)) }}" class="link-product-add-cart">Quick View</a>
                                    </div>
                                </div>
                            ...
                            <div class="item-info-product ">
                                ...
                                <div class="info-product-price">
                                    <span class="item_price">{{number_format($data->price)}} / {{$data->minimumorder}}</span>
                                    {{--<del>$390.71</del>--}}
                                </div>
