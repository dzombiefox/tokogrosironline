...
//                $(".isi").delay(100).fadeOut(100);
                ...
                for (i in data) {
                    ...
                    var html = "<div class='row'>" +
                        "<div class='col-xs-2'><img src='./public/"+image+"' class='img-responsive'> </div>" +
                        "<div class='col-xs-2'> <h4 class=\"product-name\"><strong>"+itemname+"</strong></h4><h4><small> "+item.options.unitname+"</small></h4></div>" +
                        "<div class='col-xs-8'>" +
                        "<div class='col-xs-3 text-right'><h6><strong>"+formatNumber(item.price)+" <span class='text-muted'>x</span></strong></h6></div>" +
                        "<div class='col-xs-3'><input type='text' class='form-control' value='"+item.qty+"' onkeyup=\"updatecart('"+item.rowId+"',this)\"'></div>" +
                        "<div class='col-xs-3'><h6><strong>"+formatNumber(item.subtotal)+" </strong></h6></div>" +
                        "<div class='col-xs-3'><button type='button' class='btn btn-danger btn-sm'><span class='glyphicon glyphicon-trash'></span> Hapus</button></div>" +
                        "</div>" +
                        "</div>"+
                        "<hr>"
                    $(".isi").append(html);
                ...
                var footer="  <div class=\"row\">\n" +
                    ...
                    "                                    <div class=\"col-xs-9\">\n" +
                    "                                        <h6 class=\"text-right\"><strong>Total Belanja :</strong></h6>\n" +
                    "                                    </div>\n" +
                    "                                    <div class=\"col-xs-3\">\n" +formatNumber(total)
                    "                                    </div>\n" +
                    "                                </div>\n" +
        ...
        <div class="top_nav_right">
            <div class="wthreecartaits wthreecartaits2 cart cart box_1 ">
                <form action="#" method="post" class="last">
                    ...
                    <button class="w3view-cart itemse " type="submit" name="submit" value=""><i class="fa fa-cart-arrow-down" aria-hidden="true">   </i><span class="notify-badge">{{$count}}</span></button>
                        ...
                        <div class="panel-body">
                           ...
                           <?php $total=0;
                            ...
                            @foreach($cart as $data)
                                <?php
                                $total+=$data->subtotal;
                                $datas=explode('_',$data->name); ?>

                            <div class="row">
                                <div class="col-xs-2"><img src="./public/<?=$datas[1]?>" style="width: 100%;min-width: 50px" class="img-responsive"  >
                                </div>
                                <div class="col-xs-2">
                                    <h4 class="product-name"><strong><?=$datas[0]?></strong></h4><h4><small>{{$data->options->unitname}}</small></h4>
                                </div>
                                <div class="col-xs-8">
                                    <div class="col-xs-3 text-right">
                                        <h6><strong>{{number_format($data->price)}} <span class="text-muted">x</span></strong></h6>
                                    </div>
                                    <div class="col-xs-3">
                                        <input type="text" class="form-control " value="{{$data->qty }}" onkeyup="updatecart('{{$data->rowId}}',this)">
                                    </div>
                                    <div class="col-xs-3">
                                        <h6><strong>{{number_format($data->subtotal)}} </strong></h6>
                                    </div>
                                    <div class="col-xs-3">
                        ...
                        <div class="panel-footer">
                            <div class="row text-center">
                                ...
                                <div class="col-xs-5">
                                    ...
                                    <td>
                                        @if (Auth::guest())
                                        <a data-toggle="modal" data-target="#myModal" type="button" class="btn btn-default">
